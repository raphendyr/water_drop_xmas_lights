...
CPPFLAGS += -flto               # link-time-optimization
...
LDFLAGS += -Wl,--relax
#LDFLAGS += -Wl,--relax         # from sooda
LDFLAGS += -Wl,--gc-sections
#LDFLAGS += -Wl,--gc-sections   # from sooda
...
%.fuse: %.elf
	@echo
	@echo foobar... $@
	-$(OBJCOPY) -j .fuse --no-change-warnings -O $(FORMAT) $< $@ || exit 0
